...
export default function CreateListing() {
    ...
    useEffect(()=>{
        const fetchListing = async()=>{
            ...
            const res = await fetch(`https://real-estate-backend-livid.vercel.app/api/listing/get/${listingId}`);
    ...
    const handleSubmit = async (e)=>{
        ...
        try {
            ...
            setLoading(true)
            setError(false);
            const res = await fetch(`https://real-estate-backend-livid.vercel.app/api/listing/update/${params.listingId}`, {
                method : 'POST',
                headers : {
        ...
        <form onSubmit={handleSubmit} className=' flex flex-col sm:flex-row gap-10'>
            <div className=" flex flex-col gap-4 flex-1">
                ...
                <div className=' flex flex-wrap gap-6 '>
                    ...
                    <div className=" flex gap-2 items-center">
                        <input type="number" id='regularPrice' min='2000' max='2000000000' required className=' p-3 border-gray-300 rounded-lg' onChange={handleChange} value={formData.regularPrice} />
                    ...
                    {formData.offer && (
                        <div className=" flex gap-2 items-center">
                        <input type="number" id='discountPrice' min='0' max='2000000000' required className=' p-3 border-gray-300 rounded-lg' onChange={handleChange} value={formData.discountPrice} />
                        <div className=" flex flex-col items-center">
